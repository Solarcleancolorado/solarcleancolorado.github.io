...
import "./WhyClean.scss"
import { StaticImage } from "gatsby-plugin-image"

const WhyClean = () => {
  return (
    <article className="why-clean">
        <h2 className="mb-4">Why Clean Your Solar Panels?</h2>
        <span>
        ...
        <StaticImage src="../../images/solarpanelshome2.webp" alt="Solar panel on home" className="img-fluid m-2" />
        <span>
