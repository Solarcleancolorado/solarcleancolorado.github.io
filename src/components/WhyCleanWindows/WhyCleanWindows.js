...
const WhyCleanWindows = () => {
  return (
    <article className="why-clean-windows">
      <span>
        <h2 className="mb-4">Why Clean Your Windows?</h2>
        <hr />
      </span>
      <StaticImage src="../../images/windows2.webp" alt="Clean windows in home" className="img-fluid m-2" />
      <span>
